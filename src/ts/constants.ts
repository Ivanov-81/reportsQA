...
export const SWITCH_AUTH: string = 'SWITCH_AUTH';
...
export const GREEN_COLOR_1 = 'rgb(56, 168, 86)';
export const ERROR_COLOR = '#FF6969';
export const ERROR_GREY = '#888888';

export const URL_JIRA = 'https://jira.bftcom.com/rest/greenhopper/1.0/xboard/work/allData.json?rapidViewId=994&selectedProjectKey=POPL&activeQuickFilters=3285';
